...
**Click the legend.** Toggle any signal on or off and the whole map recomputes in real time. Towers shrink, colors shift, and the skyline reorganizes itself like the intro of game of thrones except... actually it's a lot like game of thrones what with the polyamry and decitfulness #Delve. Watching a bucket of 5,700 human waste reports materialize out of the Street Cleaning category is both hilarious and a testament to the horrors of houselessness that affected so many in the wake of the opioid crisis
